...
# This file will take the outputs of 01_manifest.R and 
...
geManifest <- read_tsv('./data/tcga-luad/01_manifest.tsv') %>%
...
clin <- read_csv("./data/tcga-luad/B_01_tidy-clinical.csv")
...
write_rds(dds, "./data/tcga-luad/A_02_normalized-counts.Rds", compress = "gz")
