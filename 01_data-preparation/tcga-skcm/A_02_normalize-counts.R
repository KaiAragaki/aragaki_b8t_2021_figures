...
geManifest <- read_csv('./data/tcga-skcm/A_01_manifest.csv') %>%
...
clin <- read_csv("./data/tcga-skcm/B_01_tidy-clinical.csv")
...
write_rds(dds, "./data/tcga-skcm/A_02_normalized-counts.Rds")
